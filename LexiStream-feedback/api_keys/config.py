...
# OpenAI (for AI feedback on recordings). Set OPENAI_API_KEY in .env or environment.
# Example: create a .env file in project root with: OPENAI_API_KEY=sk-your-key-here
